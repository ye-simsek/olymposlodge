...
const olTranslations = {
    tr: {
      ...
      asd_p4: 'Terasa çıktığınızda bahçenin tüm derinliği önünüzde açılıyor. Buradan sahile kısa bir yürüyüş. Restorana ve spa\'ya da öyle. Ama oda, bunların hiçbirinin gerekli hissettirmeyeceği şekilde tasarlanmış. Şömineyi yakabilir, jakuziyi çalıştırabilir, kapıları açık bırakabilir ve bütün bir akşamı başka bir yerde olmanıza gerek kalmadan geçirebilirsiniz.',
