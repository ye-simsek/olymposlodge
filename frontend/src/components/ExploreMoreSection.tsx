          ...
          <div className="explore-more-scroll" ref={scrollRef}>
            ...
            <div className="story-block story-block--linker-tall">
              <div className="story-block__content">
                ...
                <Link to="/experiences" className="room-row__link">{t('explore_more.cirali_cta')}</Link>
              </div>
            ...
            <div className="story-block story-block--linker-tall">
              <div className="story-block__content">
                ...
                <Link to="/rooms" className="room-row__link">{t('explore_more.lodge_cta')}</Link>
              </div>
              <div className="story-block__image">
                <img
            ...
            <div className="story-block story-block--linker-tall">
              <div className="story-block__content">
                ...
                <Link to="/location" className="room-row__link">{t('explore_more.loc_cta')}</Link>
              </div>
              <div className="story-block__image">
                <img
