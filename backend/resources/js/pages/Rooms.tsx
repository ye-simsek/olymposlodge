...
export default function Rooms({ rooms }: { rooms: LocalizedRoom[] }) {
    ...
    return (
        <>
            <SeoHead title={t('meta.rooms_title')} description={t('meta.rooms_desc')} />
            ...
            <div className="offers-dark">
                ...
                <div className="offers-grid">
                    <div className="offer-card">
                        ...
                        <Link href={localePath(locale, 'booking')} className="offer-card__cta">{t('nav.reserve')} →</Link>
                    </div>
                    <div className="offer-card">
...
Rooms.layout = (page: React.ReactNode) => <Layout>{page}</Layout>;
