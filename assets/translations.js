...
const olTranslations = {
    ...
    en: {
      ...
      asd_p4: 'Step onto the terrace and the full depth of the garden opens in front of you. From here, the beach is a short walk. So is the restaurant and the spa. But the room is designed so that none of that feels necessary. You can light the fire, run the jacuzzi, leave the doors open, and let an entire evening pass without needing to be anywhere else.',
