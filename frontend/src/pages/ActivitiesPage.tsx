  ...
  return (
    <div className="page--dest page--cirali">
      <PageMeta
        lang={lang}
        path="/activities"
        title={t('meta.activities_title')}
        description={t('meta.activities_desc')}
        image="https://www.olymposlodge.com.tr/wp-content/uploads/2025/04/IMG_5376-1.jpg"
      />
      ...
      {/* Lodge linker CTA */}
      <Link to="/lodge" className="lodge-linker">
