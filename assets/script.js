...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    en: {
      ...
      room1_name: 'Aqua Super Deluxe', room1_desc: 'The most singular room on the grounds, set apart in its own detached structure at the garden\'s edge. An indoor waterfall wall and a line of glass floor panels revealing water beneath your feet set the tone. Add the jacuzzi, fireplace, indoor and outdoor rain showers, and an expansive terrace, and the boundary between architecture and nature all but disappears.',
      room2_name: 'Super Deluxe', room2_desc: 'Generous in every dimension, the Super Deluxe opens directly onto the front garden through a broad private terrace where the sea threads between the trees. A fireplace anchors the living area while the jacuzzi bathtub invites long evenings. This is a room designed for staying in as much as stepping out.',
