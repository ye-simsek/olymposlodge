...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    tr: {
      ...
      manifesto_line: 'Oda, en azından.',
      manifesto_sub: 'Kapınızın önünde antik kalıntılar. Size ait bir plaj. Çoğu misafirin büyükbabasından yaşlı bir bahçe. Oda uyuduğunuz yer — geri kalanı yaşadığınız yer.',
