...
const olTranslations = {
    tr: {
      ...
      nav_home_sub: 'kıyıya açılan kapı', nav_rooms_sub: 'on yedi oda, bir kıyı', nav_experiences_sub: 'ateş, orman, deniz',
      nav_location_sub: 'Çıralı, Antalya', nav_gallery_sub: 'ışık ve gölge', nav_offers_sub: 'erken gelen kazanır', nav_contact_sub: 'sizi bekliyoruz',
      nav_menu: 'Menü', nav_menu_sub: 'mutfaktan kıyıya',
      ...
      story_eyebrow_story: 'Hikayemiz',
      story_eyebrow_nature: 'Felsefe',
      about_label: 'Hikayemiz',
      about_heading: 'Yıllar önce, bir adam <em class="accent-word">zümrüt</em> bir vadiden indi ve kendisini bekleyen denizi buldu.',
      about_p1: 'Vadi bir dereye daraldı. Dere denize açıldı. Burası ondan hiçbir şey istemedi. Taşıdıklarını yere bıraktı.',
      about_p2: 'O huzurdan Olympos Lodge doğdu. Yirmi bin metrekarelik bahçeye yerleştirilmiş on yedi tek katlı oda.',
      about_p3: 'Onun yürüdüğü yolu yürüyün. Vadi hâlâ daralıyor. Dere hâlâ açılıyor. Deniz hâlâ bekliyor.',
      ...
      room4_name: 'Göl Evi', room4_desc: 'Tesisin geri kalanından ayrı konumlanan müstakil bir oda; terasın ötesinde bir gölet uzanıyor. Yüzeyi bahçenin ışığını, aydınlık gecelerde ise ayı ikiye katlıyor. İçeride bir şömine, mahremiyet mimarinin içine işlenmiş.',
      ...
      rooms_include_wifi: 'Wi-Fi',
      rooms_include_ac: 'Klima',
      rooms_include_terrace: 'Özel Teras',
      nature_label: 'Bahçe, Deniz, Doğa',
      nature_heading: 'Doğa zaten mükemmel;<br>ona saygı duy,<br>onu dinle ve<br>onunla birlikte <em class="accent-word">yarat</em>.',
      ...
      contact_address_value: 'Çıralı Yolu 9, Ulupınar Mahallesi<br>Kemer / Antalya<br>Türkiye',
      ...
      contact_salutation_prof: 'Prof.',
      contact_salutation_sayin: 'Sayın',
      ...
      footer_address: 'Çıralı Yolu 9, Ulupınar Mahallesi<br>Kemer / Antalya<br>Türkiye',
      ...
      c_ch1_cat: 'Plaj', c_ch1_title: 'Çıralı Sahili', c_ch1_eyebrow: 'Akdeniz',
      c_ch1_lead: 'Üç buçuk kilometre boyunca uzanan, ince çakıldan oluşan el değmemiş bir Akdeniz kıyısı. Kıyı şeridinin tamamı doğal sit alanı; oteller ve restoranlar sahil hattına inşa edilemez. Her yıl Mayıs\'tan Eylül\'e kadar Caretta caretta deniz kaplumbağaları bu plajda yumurtalar.',
      ...
      c_ch2_cat: 'Arkeoloji', c_ch2_title: 'Olympos Antik Kenti', c_ch2_caption: 'Fig. II — Olympos Antik Kenti, MÖ 2. yüzyıl', c_ch2_locus: 'Çıralı · 36.40°N', c_ch2_pullquote: 'Olympos bir ziyaret değil, karşılaşmadır.', c_ch2_attribution: '— sahadan',
      ...
      c_ch3_cat: 'Doğa', c_ch3_title: 'Sönmeyen Alevler', c_ch3_eyebrow: 'Yanartaş',
      ...
      c_ch4_cat: 'Yürüyüş', c_ch4_title: 'Likya Yolu', c_ch4_caption: 'Fig. IV — Likya Yolu, Olympos–Adrasan etabı', c_ch4_locus: '540 km · 2000 m rakım', c_ch4_pullquote: 'Dünyanın en iyi on yürüyüş rotasından biri.', c_ch4_attribution: '— The Sunday Times',
      c_ch4_lead: '540 kilometrelik patika, Çıralı\'dan geçer. Antik kentler, Likya mezarları, ıssız koylar ve dağ köyleri birbirini izler. Çıralı bölümü Olympos–Adrasan hattını kapsar.',
      ...
      c_tekne_desc: 'Tamamen size özel bir gün. Güzergahı, molaları ve süreyi siz belirlersiniz. Olympos koyları, Adrasan, ıssız kumsallar ya da sadece açık denizin sessizliği; istediğiniz kadar uzun, istediğiniz kadar sakin. Konsiyerjimiz aracılığıyla ayarlanır.',
      c_tekne_f1: '<span>Süre</span><strong>Size özel</strong>', c_tekne_f2: '<span>Güzergah</span><strong>Size özel</strong>',
      ...
      act_lodge_label: 'Konaklamada',
      act_lodge_eyebrow: 'Devamında',
      act_lodge_title: 'Konaklamada',
      act_lodge_lead: 'Spa, özel plaj ve spor ekipmanları konaklamanızın parçasıdır. Kapıdan çıktığınız anda size eşlik ederler.',
      ...
      amenity_furniture: 'El Yapımı Mobilya', amenity_minibar: 'Mini Bar', amenity_wifi: 'Wi-Fi',
      ...
      sd_p3: 'Şömine oturma alanını tanımlıyor; serin gecelerde oda farklı bir sıcaklık kazanır. Jakuzi küvet yağmur duşuyla birlikte geliyor. Espresso makinesi ve minibar. İçeride kalmak için dışarıdan hiçbir şeye ihtiyacınız yok.',
    ...
    en: {
      ...
      nav_home_sub: 'a gate to the shore', nav_rooms_sub: 'seventeen rooms, one shore', nav_experiences_sub: 'fire, forest, sea',
      nav_location_sub: 'Çıralı, Antalya', nav_gallery_sub: 'light and shadow', nav_offers_sub: 'early arrivals win', nav_contact_sub: 'we are waiting for you',
      nav_menu: 'Menu', nav_menu_sub: 'from kitchen to shore',
      ...
      story_eyebrow_story: 'Our Story',
      story_eyebrow_nature: 'Philosophy',
      about_label: 'Our Story',
      about_heading: 'Years ago, a man walked down through an <em class="accent-word">emerald</em> valley and found the sea waiting for him.',
      about_p1: 'The valley narrowed to a stream. The stream opened to the sea. Nothing here asked anything of him. He set down what he was carrying.',
      about_p2: 'From that stillness, Olympos Lodge grew. Seventeen rooms, single-storey, set across twenty thousand square metres of garden.',
      about_p3: 'Walk the path he walked. The valley still narrows. The stream still opens. The sea is still waiting.',
      ...
      room4_name: 'Lake House', room4_desc: 'A detached cottage set apart from the rest of the property, with a pond stretching beyond the terrace. Its surface doubles the garden\'s light and, on bright nights, the moon. A fireplace inside, privacy built into the architecture.',
      ...
      nature_heading: 'Nature is already perfect; respect&nbsp;it, listen to&nbsp;it, and <em class="accent-word">create</em> alongside&nbsp;it.',
      ...
      c_ch1_cat: 'Beach', c_ch1_title: 'Çıralı Beach', c_ch1_eyebrow: 'Mediterranean',
      ...
      c_ch2_cat: 'Archaeology', c_ch2_title: 'Ancient City of Olympos', c_ch2_caption: 'Fig. II — Ancient City of Olympos, 2nd century BC', c_ch2_locus: 'Çıralı · 36.40°N', c_ch2_pullquote: 'Olympos isn\'t a visit. It\'s an encounter.', c_ch2_attribution: '— from the field',
      c_ch2_lead: 'Step through the garden and walk ten minutes to find yourself inside one of Lycia\'s best-preserved cities. Roman-era tombs, theatre ruins, and walls that reach toward the sea.',
      c_ch3_cat: 'Nature', c_ch3_title: 'The Eternal Flames', c_ch3_eyebrow: 'Yanartaş',
      ...
      c_ch4_cat: 'Hiking', c_ch4_title: 'Lycian Way', c_ch4_caption: 'Fig. IV — Lycian Way, Olympos–Adrasan section', c_ch4_locus: '540 km · 2000 m elevation', c_ch4_pullquote: 'One of the world\'s ten finest walking routes.', c_ch4_attribution: '— The Sunday Times',
      c_ch4_lead: 'This 540-kilometre trail passes through Çıralı. Ancient cities, Lycian tombs, remote coves, and mountain villages follow one another in turn. The Çıralı section covers the Olympos–Adrasan stretch.',
      ...
      c_tekne_desc: 'A day shaped entirely around you. You choose the route, the stops, and the pace. Olympos coves, Adrasan, hidden beaches, or nothing but the quiet of open water; as long or as still as you like. Arranged through our concierge.',
      c_tekne_f1: '<span>Duration</span><strong>Your choice</strong>', c_tekne_f2: '<span>Route</span><strong>Your choice</strong>',
      ...
      c_tahtali_label: 'Panorama', c_tahtali_title: 'Olympos Cable Car',
      ...
      act_lodge_label: 'At the Lodge',
      act_lodge_eyebrow: 'Continue to',
      act_lodge_title: 'At the Lodge',
      act_lodge_lead: 'Spa, private beach and sports equipment are part of your stay. They accompany you the moment you step outside.',
      ...
      amenity_furniture: 'Handmade Furniture', amenity_minibar: 'Mini Bar', amenity_wifi: 'Wi-Fi',
      ...
      sd_p3: 'The fireplace defines the sitting area; the room takes on a different warmth on cool evenings. A jacuzzi tub comes with a rain shower. An espresso machine and a minibar. Nothing you need outside that you cannot find in here.',
    ...
    de: {
      ...
      nav_home_sub: 'ein Tor zum Ufer', nav_rooms_sub: 'siebzehn Zimmer, eine Küste', nav_experiences_sub: 'Feuer, Wald, Meer',
      nav_location_sub: 'Çıralı, Antalya', nav_gallery_sub: 'Licht und Schatten', nav_offers_sub: 'wer früh kommt, gewinnt', nav_contact_sub: 'wir erwarten Sie',
      nav_menu: 'Speisekarte', nav_menu_sub: 'von der Küche zur Küste',
      ...
      story_eyebrow_story: 'Unsere Geschichte',
      story_eyebrow_nature: 'Philosophie',
      about_label: 'Unsere Geschichte',
      about_heading: 'Vor Jahren stieg ein Mann durch ein <em class="accent-word">smaragdgrünes</em> Tal hinab und fand das Meer, das auf ihn wartete.',
      about_p1: 'Das Tal verengte sich zu einem Bach. Der Bach öffnete sich zum Meer. Nichts hier verlangte etwas von ihm. Er legte ab, was er trug.',
      about_p2: 'Aus dieser Stille wuchs Olympos Lodge. Siebzehn einstöckige Zimmer, verteilt über zwanzigtausend Quadratmeter Garten.',
      about_p3: 'Gehen Sie den Weg, den er ging. Das Tal verengt sich noch immer. Der Bach öffnet sich noch immer. Das Meer wartet noch immer.',
      ...
      room4_name: 'Seehaus', room4_desc: 'Ein freistehendes Häuschen, abseits vom Rest der Anlage, mit einem Teich jenseits der Terrasse. Seine Oberfläche verdoppelt das Licht des Gartens und in hellen Nächten den Mond. Drinnen ein Kamin, Privatsphäre in die Architektur eingebaut.',
      ...
      rooms_include_wifi: 'WLAN',
      rooms_include_ac: 'Klimaanlage',
      rooms_include_terrace: 'Private Terrasse',
      nature_label: 'Garten, Meer, Natur',
      nature_heading: 'Die Natur ist bereits vollkommen;<br>respektiere sie,<br>höre ihr zu und<br><em class="accent-word">erschaffe</em> mit ihr.',
      ...
      contact_address_value: 'Çıralı Yolu 9, Ulupınar Mahallesi<br>Kemer / Antalya<br>Türkei',
      contact_hours_label: 'Information',
      contact_checkin: 'Check-in',
      contact_checkout: 'Check-out',
      ...
      footer_address: 'Çıralı Yolu 9, Ulupınar Mahallesi<br>Kemer / Antalya<br>Türkei',
      ...
      c_ch1_cat: 'Strand', c_ch1_title: 'Çıralı Strand', c_ch1_eyebrow: 'Mittelmeer',
      ...
      c_ch2_cat: 'Archäologie', c_ch2_title: 'Antike Stadt Olympos', c_ch2_caption: 'Abb. II — Antike Stadt Olympos, 2. Jh. v. Chr.', c_ch2_locus: 'Çıralı · 36.40°N', c_ch2_pullquote: 'Olympos ist kein Besuch. Es ist eine Begegnung.', c_ch2_attribution: '— aus dem Feld',
      c_ch2_lead: 'Treten Sie durch den Garten und gehen Sie zehn Minuten, um sich in einer der besterhaltenen Städte Lykiens wiederzufinden. Grabmäler aus der Römerzeit, Theaterreste und Mauern, die sich zum Meer hin erstrecken.',
      c_ch3_cat: 'Natur', c_ch3_title: 'Die ewigen Flammen', c_ch3_eyebrow: 'Yanartaş',
      ...
      c_ch4_cat: 'Wandern', c_ch4_title: 'Lykischer Weg', c_ch4_caption: 'Abb. IV — Lykischer Weg, Etappe Olympos–Adrasan', c_ch4_locus: '540 km · 2000 m Höhe', c_ch4_pullquote: 'Eine der zehn schönsten Wanderrouten der Welt.', c_ch4_attribution: '— The Sunday Times',
      c_ch4_lead: 'Der 540 Kilometer lange Wanderweg führt durch Çıralı. Antike Städte, lykische Gräber, abgelegene Buchten und Bergdörfer wechseln einander ab. Der Çıralı-Abschnitt umfasst die Strecke Olympos–Adrasan.',
      ...
      c_tekne_desc: 'Ein Tag ganz nach Ihrem Wunsch. Sie bestimmen die Route, die Stopps und das Tempo. Olympos-Buchten, Adrasan, versteckte Strände oder nur die Stille des offenen Meeres; so lang oder so ruhig, wie Sie möchten. Arrangiert über unseren Concierge.',
      c_tekne_f1: '<span>Dauer</span><strong>Nach Wunsch</strong>', c_tekne_f2: '<span>Route</span><strong>Nach Wunsch</strong>',
      ...
      c_tahtali_label: 'Panorama', c_tahtali_title: 'Olympos Seilbahn',
      ...
      act_lodge_label: 'In der Lodge',
      act_lodge_eyebrow: 'Weiter zu',
      act_lodge_title: 'In der Lodge',
      act_lodge_lead: 'Spa, Privatstrand und Sportausrüstung gehören zu Ihrem Aufenthalt. Sie begleiten Sie, sobald Sie vor die Tür treten.',
      ...
      amenity_furniture: 'Handgefertigte Möbel', amenity_minibar: 'Minibar', amenity_wifi: 'WLAN',
      ...
      sd_p3: 'Der Kamin definiert den Sitzbereich; das Zimmer gewinnt an kühlen Abenden eine andere Wärme. Eine Whirlpool-Badewanne kommt mit einer Regendusche. Eine Espressomaschine und eine Minibar. Nichts, was Sie draußen brauchen und hier nicht finden.',
