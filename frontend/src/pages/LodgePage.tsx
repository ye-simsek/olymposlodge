  ...
  return (
    <div className="page--dest page--cirali">
      <PageMeta
        lang={lang}
        path="/lodge"
        title={t('meta.lodge_title')}
        description={t('meta.lodge_desc')}
      ...
      <section className="story-philosophy">
        ...
        <div className="story-block">
          <div className="story-block__content">
            ...
            <Link to="/experiences" className="room-row__link">{l('linker_cirali_cta')}</Link>
          </div>
        ...
        <div className="story-block story-block--reverse">
          ...
          <div className="story-block__content">
            ...
            <Link to="/activities" className="room-row__link">{l('linker_activities_cta')}</Link>
          </div>
        </div>
        ...
        <div className="story-block">
          <div className="story-block__content">
            ...
            <Link to="/location" className="room-row__link">{l('linker_loc_cta')}</Link>
          </div>
          <div className="story-block__image">
            <img
