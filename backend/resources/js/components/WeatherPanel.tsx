    ...
    const current = weather
        ? activeDay === 0
            ? {
                ...
                desc: wmoDesc(weather.current.weathercode, locale),
            ...
            : {
                ...
                desc: wmoDesc(weather.daily.weathercode[activeDay], locale),
            ...
            <div className="weather-panel__strip">
                {weather?.daily.time.slice(0, 5).map((dateStr, i) => (
                    <div className="wp-strip-cell" key={i}>
                        ...
                        <span className="wp-strip-desc">{wmoDesc(weather.daily.weathercode[i], locale)}</span>
