...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    en: {
      ...
      intro_p5: 'The front garden is the kind of place where a yoga mat or a book both make equal sense. Bicycles are there to explore Çıralı village and the roads beyond.',
