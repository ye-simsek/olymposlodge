...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    tr: {
      ...
      intro_p4: 'Günler burada ajansız açılır. Plajdaki bir şezlonga uzanın, sabahı geçsin. Bir kano çıkarın ve kıyıyı kendi hızınızda keşfedin — ya da daha uzağa bir tekne turu için konsiyer ile iletişime geçin.',
      intro_p5: 'Ön bahçe, bir yoga matının da bir kitabın da eşit anlam taşıdığı türden bir yer. Bisikletler Çıralı köyünü ve çevresindeki yolları keşfetmek için hazır. Akşamları bahçede ateşler yakılır — toplanmak, içki içmek ve sohbetin kendi akışını bulmasına izin vermek için. Ve gün hiçbir şey istemediğinde, özel spa orada: jakuzi, sauna, buhar odası — tamamen sizin.',
    ...
    en: {
      ...
      intro_p5: 'The front garden is the kind of place where a yoga mat or a book both make equal sense. Bicycles are there to explore Çıralı village and the roads beyond. In the evening, firepits are lit — a place to gather, pour a drink, and let the conversation find its own current. And when the day asks for nothing at all, the private spa is there: jacuzzi, sauna, steam room — entirely yours.',
    ...
    de: {
      ...
      intro_p5: 'Der Vorgarten ist genau der Ort, an dem eine Yogamatte und ein Buch gleichermaßen Sinn ergeben. Fahrräder stehen bereit, um das Dorf Çıralı und die umliegenden Straßen zu erkunden. Abends werden im Garten Feuer entzündet — zum Zusammenkommen, um einen Drink zu genießen und das Gespräch seinen eigenen Lauf nehmen zu lassen. Und wenn der Tag nichts mehr verlangt, ist das private Spa da: Whirlpool, Sauna, Dampfbad — ganz für Sie allein.',
