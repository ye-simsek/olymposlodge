...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    tr: {
      ...
      room1_name: 'Aqua Super Deluxe', room1_desc: 'Tesisin en eşsiz odası, bahçenin ucunda müstakil bir yapı olarak konumlanmış. İç mekandaki şelale duvarı ve ayaklarınızın altında suyu gösteren cam zemin panelleri tonu belirliyor. Jakuzi, şömine, iç ve dış mekan yağmur duşları ve geniş bir terası da ekleyin; mimari ile doğa arasındaki sınır neredeyse ortadan kalkıyor.',
      room2_name: 'Super Deluxe', room2_desc: 'Her yönüyle ferah, Super Deluxe geniş özel terası aracılığıyla doğrudan ön bahçeye açılıyor; deniz ağaçların arasından süzülüyor. Şömine oturma alanını tanımlarken jakuzi küvet uzun akşamlara davet ediyor. Dışarı çıkmak kadar içeride kalmak için de tasarlanmış bir oda.',
      room3_name: 'Deluxe', room3_desc: 'Bir konut kadar ferah, bir sığınak kadar samimi. Deluxe, jakuzi ve şömineyi bahçeye bakan geniş bir terasla buluşturuyor. Dekorasyonun büyük kısmını üstlenen Akdeniz ışığı ile sakin bir konfor kompozisyonu.',
