...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    tr: {
      ...
      room1_name: 'Aqua Super Deluxe', room1_desc: 'Tesisin en eşsiz odası, bahçenin ucunda müstakil bir yapı olarak konumlanmış. İç mekandaki şelale duvarı ve ayaklarınızın altında suyu gösteren cam zemin panelleri tonu belirliyor. Mimari ile doğa arasındaki sınır neredeyse ortadan kalkıyor.',
