...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    tr: {
      ...
      room1_name: 'Aqua Super Deluxe', room1_desc: 'Odanın dış kenarına yürüyün ve aşağıya bakın — cam zeminin altında durgun su, her adımda ışığı değiştirir. Bahçenin en uzak ucunda, tamamen müstakil konuşlanmış bu köşeli suite tesisteki her şeyden farklı. İçeride: şelale duvarı, özel jakuzi ve şömine.',
      room2_name: 'Super Deluxe', room2_desc: 'Terastan bakıldığında bahçe tüm genişliğiyle açılır — ağaçların arasından, ufukta ince bir deniz çizgisi belirir. Bu geniş süitler bahçenin ön cephesine konumlanmış; özel jakuzi ve şömine içeride. Deniz burada kendini ilan etmez, sadece fark edilmeyi bekler.',
      room3_name: 'Deluxe', room3_desc: 'Dışarı çıktığınızda bahçe her yönde çerçeveyi doldurur — ağaçların aralandığı uzak kenarda küçük bir mavi deniz dilimi belirir. Özel jakuzi ve şömine bu odayı yalnızca uyumak için değil, yaşamak için tasarlanmış hale getirir. Bahçenin ön cephesine yakın; her şeye yakın.',
      room4_name: 'Göl Evi', room4_desc: 'Uyandığınızda havuz doğrudan dışarıya uzanır — yüzeyi bahçenin ışığını yansıtan bir ayna gibidir. Parlak gecelerde dolunay suda ikiye katlanır. Bu müstakil bungalov bahçenin sakin bir köşesinde kendi başına durur; serin aylarda şömineyle.',
      room5_name: 'Antik Oda', room5_desc: 'Ortada pirinç bir yatak; çevresinde on yıllar boyunca özenle biriktirilmiş antika mobilyalar, katmanlı dokular ve zamanın ağırlığını taşıyan objeler. Tesisteki gerçek anlamda müstakil az sayıdaki odadan biri, bahçenin kendi köşesine ayrılmış. Buradaki hiçbir şey dün gelmiş gibi görünmez.',
      room6_name: 'Standart Oda', room6_desc: 'Arka bahçeye yerleştirilmiş on oda — her biri doğrudan yeşile açılır, her biri arka bahçenin sakladığı sessizliği taşır. Sade, düşünceli ve eksiksiz; dolu geçen bir günün ardından dönülecek bir yer.',
    ...
    en: {
      ...
      room1_name: 'Aqua Super Deluxe', room1_desc: 'Walk to the outer edge and look down — still water moves beneath the glass floor, the light shifting with every step. Set completely apart at the far end of the garden, this angular suite is unlike anything else on the property. Inside: a waterfall wall, private jacuzzi, and fireplace.',
      room2_name: 'Super Deluxe', room2_desc: 'The garden unfolds fully from your terrace — and between the trees, a thin line of sea appears at the horizon. These spacious suites sit at the front of the garden, with a private jacuzzi and fireplace. The sea does not announce itself here; it simply waits to be noticed.',
      room3_name: 'Deluxe', room3_desc: 'Step outside and the garden fills every direction — a sliver of blue sea visible where the trees part at the far edge. A private jacuzzi and fireplace make this more than a room to sleep in. Close to the front of the garden; close to everything.',
      room4_name: 'Lake House', room4_desc: 'Wake to the pond stretched directly outside, its surface a mirror for the garden\'s light. On bright nights, a full moon doubles in the water. This detached cottage stands alone, with a fireplace for the cooler months.',
      room5_name: 'Antique Room', room5_desc: 'A brass bed at the centre; around it, decades of carefully gathered antique furniture, layered textiles, and objects that carry the weight of time. One of the few truly standalone rooms on the property, set apart in its own corner of the garden. Nothing here looks like it arrived yesterday.',
      room6_name: 'Standard Room', room6_desc: 'Ten rooms arranged across the back garden, each opening directly onto greenery, each carrying the quietness the back garden keeps to itself. Simple, considered, and complete — a place to return to after a full day.',
    ...
    de: {
      ...
      room1_name: 'Aqua Super Deluxe', room1_desc: 'Gehen Sie zur äußeren Kante und schauen Sie nach unten — unter dem Glasfußboden bewegt sich stilles Wasser, das Licht wandelt sich mit jedem Schritt. Diese eckige Suite steht vollständig freistehend am weitesten Ende des Gartens und ist auf dem Anwesen einzigartig. Drinnen: eine Wasserwand, privater Whirlpool und Kamin.',
      room2_name: 'Super Deluxe', room2_desc: 'Von der Terrasse entfaltet sich der Garten in voller Breite — und zwischen den Bäumen zeigt sich am Horizont ein dünner Meeresstreifen. Diese geräumigen Suiten liegen an der Vorderseite des Gartens, mit privatem Whirlpool und Kamin. Das Meer kündigt sich hier nicht an; es wartet einfach darauf, bemerkt zu werden.',
      room3_name: 'Deluxe', room3_desc: 'Treten Sie hinaus und der Garten füllt jeden Blickwinkel — wo die Bäume am fernen Rand auseinandergehen, erscheint ein Streifen blaues Meer. Privater Whirlpool und Kamin machen dieses Zimmer zu mehr als einem Schlafplatz. Nah an der Vorderseite des Gartens; nah an allem.',
      room4_name: 'Seehaus', room4_desc: 'Erwachen Sie mit dem Teich, der sich unmittelbar draußen erstreckt — seine Oberfläche spiegelt das Licht des Gartens. In hellen Nächten verdoppelt sich ein Vollmond im Wasser. Dieses freistehende Bungalow steht allein in einer stilleren Gartenecke, mit Kamin für die kühleren Monate.',
      room5_name: 'Antikes Zimmer', room5_desc: 'Ein Messingbett im Mittelpunkt; darum herum jahrzehntelang sorgfältig gesammelte Antiquitäten, geschichtete Textilien und Objekte, die das Gewicht der Zeit tragen. Eines der wenigen wirklich freistehenden Zimmer auf dem Anwesen, in seiner eigenen Gartenecke gelegen. Nichts hier sieht aus, als wäre es gestern angekommen.',
      room6_name: 'Standardzimmer', room6_desc: 'Zehn Zimmer im hinteren Garten — jedes öffnet sich direkt ins Grüne, jedes trägt die Stille, die der hintere Garten für sich behält. Schlicht, durchdacht und vollständig — ein Ort, zu dem man nach einem erfüllten Tag zurückkehrt.',
